...
<template>
  <div class="flex flex-col gap-4">
    ...
    <GuideSection title="این اپلیکیشن چطور کار می‌کند" icon="📱">
      <p>
        این اپلیکیشن یک ردیاب سیکل قاعدگی <strong>Local-First</strong> است؛ یعنی تمام داده‌های شما (تاریخ‌های پریود، علائم) فقط روی همین دستگاه و در حافظه مرورگر (IndexedDB) ذخیره می‌شود و به هیچ سروری ارسال نمی‌شود.
      </p>
